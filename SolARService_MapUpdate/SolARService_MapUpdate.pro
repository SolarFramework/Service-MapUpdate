...
linux {
    ...
    run_install_cuda.files = $${PWD}/start_mapupdate_service_cuda.sh
    CONFIG(release,debug|release) {
        run_install_cuda.extra = cp $$files($${PWD}/start_mapupdate_service_release_cuda.sh) $${PWD}/start_mapupdate_service_cuda.sh
    }
    CONFIG(debug,debug|release) {
        run_install_cuda.extra = cp $$files($${PWD}/start_mapupdate_service_debug_cuda.sh) $${PWD}/start_mapupdate_service_cuda.sh
    }
...
DISTFILES += \
    ...
    start_mapupdate_service_debug_cuda.sh \
    start_mapupdate_service_release.sh \
    start_mapupdate_service_release_cuda.sh
