...
export XPCF_GRPC_SERVER_URL=0.0.0.0:60053
...
for modulePath in $(grep -o "\$XPCF_MODULE_ROOT.*lib" SolARService_MapUpdate_modules_cuda.xml)
do
...
LD_LIBRARY_PATH=$ld_library_path ./SolARService_MapUpdate -m SolARService_MapUpdate_modules.xml -p SolARService_MapUpdate_properties.xml -t cuda $@
