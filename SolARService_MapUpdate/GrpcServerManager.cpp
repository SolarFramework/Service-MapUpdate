...
GrpcServerManager::~GrpcServerManager()
{
    ...
    m_serviceManager->unregisterService(api::pipeline::ServiceType::MAP_UPDATE_SERVICE, m_externalURL);
}
...
void GrpcServerManager::runServer()
{
    ...
    m_serviceManager->registerService(api::pipeline::ServiceType::MAP_UPDATE_SERVICE, m_externalURL);
